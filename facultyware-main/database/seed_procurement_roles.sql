...
(9004, 'Admin Facultyware', 'admin@facultyware.test', NOW(), @PASSWORD_HASH, NOW(), NOW())
...
(9004, 'EMP-PROC-004', NULL, NULL, 'Admin Facultyware', 'Padang', '1985-01-01', 'male', NULL, 'married', 'Kampus UNAND', '080000000004', 9001, '2020-01-01', 9001, 'active', NOW(), NOW())
...
(9004, 'App\\Models\\User', 9004),
(9005, 'App\\Models\\User', 9004);
...
(9001, 9004), (9002, 9004), (9003, 9004), (9004, 9004), (9005, 9004), (9006, 9004), (9007, 9004), (9008, 9004), (9009, 9004);
